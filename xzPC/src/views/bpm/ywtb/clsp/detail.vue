<template>
  <div class="app-container">
    ...
    <el-card class="box-card" >
      ...
      <div class="sqcl">
        <UploadImage :disabled="true" :fileLists="files" :title="'人口信息查询申请表'"></UploadImage>
        <UploadImage  :disabled="true"  :fileLists="files" :title="'流动人口居住登记情况'"></UploadImage>
        <UploadImage :disabled="true"  :fileLists="files" :title="'人口信息查询证明'"></UploadImage>
      </div>
    </el-card>
  </div>
</template>
