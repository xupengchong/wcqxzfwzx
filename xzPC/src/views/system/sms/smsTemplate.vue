  ...
  <div class="app-container">
    ...
    <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="150px">
      <el-form-item label="短信类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择短信类型" clearable size="small">
          <el-option
            v-for="dict in this.getDictDatas(DICT_TYPE.SYSTEM_SMS_TEMPLATE_TYPE)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-dialog title="测试发送短信" :visible.sync="sendSmsOpen" width="500px" append-to-body>
      <el-form ref="sendSmsForm" :model="sendSmsForm" :rules="sendSmsRules" label-width="140px">
        ...
        <el-form-item v-for="(param,index) in sendSmsForm.params" :key="index" :label="'参数 {' + param + '}'" :prop="'templateParams.' + param">
...
import { createSmsTemplate, deleteSmsTemplate, exportSmsTemplateExcel, getSmsTemplate, getSmsTemplatePage, sendSms, updateSmsTemplate } from '@/api/system/sms/smsTemplate'
