  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableList">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-hasPermi="['tool:codegen:preview']" type="text" size="small" icon="el-icon-view" @click="handlePreview(scope.row)">预览</el-button>
          <el-button v-hasPermi="['tool:codegen:update']" type="text" size="small" icon="el-icon-edit" @click="handleEditTable(scope.row)">编辑</el-button>
          <el-button v-hasPermi="['tool:codegen:delete']" type="text" size="small" icon="el-icon-delete" @click="handleDelete(scope.row)">删除</el-button>
          <el-button v-hasPermi="['tool:codegen:update']" type="text" size="small" icon="el-icon-refresh" @click="handleSynchDb(scope.row)">同步</el-button>
          <el-button v-hasPermi="['tool:codegen:download']" type="text" size="small" icon="el-icon-download" @click="handleGenTable(scope.row)">生成代码</el-button>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-col :span="17">
          <el-tabs v-model="preview.activeName">
            <el-tab-pane
              ...
              :name="item.filePath"
            >
              <el-link v-clipboard:copy="item.code" v-clipboard:success="clipboardSuccess" :underline="false" icon="el-icon-document-copy" style="float:right">复制</el-link>
              <pre><code class="hljs" v-html="highlightedCode(item)" /></pre>
            </el-tab-pane>
          </el-tabs>
        </el-col>
      </el-row>
