    ...
    return {
      listDatas: [
        ...
        },
        {
          ...
          lowColor: '#eb6c3a',
          list: [
            {icon: '../../static/icon/hjxx.png', title: '户籍信息', hint: '户籍信息查询',url:'pages/kssq/koseki/koseki'},
            {icon: '../../static/icon/ldrk.png', title: '流动人口', hint: '流动人口信息查询',url:'pages/kssq/applyDetail/applyDetail'},
						{icon: '../../static/icon/qsgx.png', title: '亲属关系', hint: '亲属关系',url:'pages/kssq/kinsfolk/kinsfolk'},
            {icon: '../../static/icon/swzx.png', title: '死亡注销', hint: '死亡注销信息查询',url:'pages/ywtb/applyDetail/applyDetail'},
            {icon: '../../static/icon/zf.png', title: '工商信息', hint: '工商登记信息查询',url:'pages/kssq/aaum/aaum'},
            {icon: '../../static/icon/fcxx.png', title: '房产信息', hint: '房产信息查询'},
						...
						{icon: '../../static/icon/csxx.png', title: '出生信息', hint: '出生证明',url:'pages/kssq/birth/birth'},
